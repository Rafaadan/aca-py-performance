...
(CON POSIBILIDAD DE REVOCACION) ENTRE DOS AGENTES, Y REVOCANDO TODAS AL FINAL.
...
def main(
   tails_server_base_url: str = None, #url del servidor tails para las revocaciones
    ...
    #Numero de credenciales que se quieren probar y el número de pruebas a realizar con cada una
    ...
    for cred in credenciales:
        for prueba in range(1, pruebas + 1):
            ...
            if(not os.path.exists(f"/home/rafa/aca-py-performance/demo/pruebas/CR/revocando/{cred}_credenciales")):
                os.makedirs(f"/home/rafa/aca-py-performance/demo/pruebas/CR/revocando/{cred}_credenciales")
                os.makedirs(f"/home/rafa/aca-py-performance/demo/pruebas/CR/revocando/{cred}_credenciales/datosCPUyRAM")
            ...
            cpu_process = subprocess.Popen(["bash", "cpu_y_ram.sh", f"{pid}", f"/home/rafa/aca-py-performance/demo/pruebas/CR/revocando/{cred}_credenciales/datosCPUyRAM/CPU_{cred}_credenciales_prueba_{prueba}.txt"])
            ...
            file = open(f"/home/rafa/aca-py-performance/demo/pruebas/CR/revocando/{cred}_credenciales/prueba{prueba}_con_{cred}_credenciales.txt","w")

...
datastartup.to_excel(f"tablas_excel/CS/startup.xlsx")
datastartup.plot(kind='box', title=f"Startup CS", legend=True, xlabel="Numero de credenciales", ylabel = "Tiempo (s)")
plt.show()
...
dataconnect.to_excel(f"tablas_excel/CS/connect.xlsx")
dataconnect.plot(kind='box', title=f"Connect CS", legend=True, xlabel="Numero de credenciales", ylabel = "Tiempo (s)")
plt.show()
...
datapublish.to_excel(f"tablas_excel/CS/publish.xlsx")
datapublish.plot(kind='box', title=f"Publish CS", legend=True, xlabel="Numero de credenciales", ylabel = "Tiempo (s)")
plt.show()
...
dataavgcred.to_excel(f"tablas_excel/CS/avgcred.xlsx")
dataavgcred.plot(kind='box', title=f"Avg per credential CS", legend=True, xlabel="Numero de credenciales", ylabel = "Tiempo (s)")
plt.show()
...
dataavgproof.to_excel(f"tablas_excel/CS/avgproof.xlsx")
dataavgproof.plot(kind='box', title=f"Avg per proof CS", legend=True, xlabel="Numero de credenciales", ylabel = "Tiempo (s)")
plt.show()
...
datatotal.to_excel(f"tablas_excel/CS/total.xlsx")
datatotal.plot(kind='box', title=f"Total CS no revocation", legend=True, xlabel="Numero de credenciales", ylabel = "Tiempo (s)")
plt.show()

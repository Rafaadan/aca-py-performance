...
SCRIPT PARA PLOTEAR LAS PRUEBAS GENERADAS CON EL SCRIPT PROOF_PRESENTATION_CR_ALL_AT_ONCE_REVOCATION.PY
...
for cred in credenciales:
    ...
    for prueba in range(1,pruebas+1):
        ...
        with open(f"/home/rafa/aca-py-performance/demo/pruebas/CR/revocando/{cred}_credenciales/prueba{prueba}_con_{cred}_credenciales.txt","r") as file:
            for line in file:
        ...
        with open(f"/home/rafa/aca-py-performance/demo/pruebas/CR/revocando/{cred}_credenciales/datosCPUyRAM/CPU_{cred}_credenciales_prueba_{prueba}.txt","r") as file:
            total_cpu = 0
            total_ram = 0
            contador = 0
            for line in file:
...
if(not os.path.exists(f"/home/rafa/aca-py-performance/demo/tablas_excel/CR/revocando")):
    os.makedirs(f"/home/rafa/aca-py-performance/demo/tablas_excel/CR/revocando")
...
for cred in range(1, len(credenciales)+1):
    ...
    dataframe.describe().to_excel(f"tablas_excel/CR/revocando/{credenciales[cred-1]}_credenciales_describe.xlsx")
...
print(f"TABLA FINAL \n")
print(df_final)
df_final.to_excel("tablas_excel/CR/revocando/tablafinal.xlsx")
